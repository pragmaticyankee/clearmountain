...
<div class="panel">
	...
	<h2><?php echo (isset($this->_rootref['SITENAME'])) ? $this->_rootref['SITENAME'] : ''; ?> - <?php echo ((isset($this->_rootref['L_REGISTRATION'])) ? $this->_rootref['L_REGISTRATION'] : ((isset($user->lang['REGISTRATION'])) ? $user->lang['REGISTRATION'] : '{ REGISTRATION }')); ?><br>*** (Please wait at least 1 minute before going to another page after pushing SUBMIT button) ***</h2>
...
<h3>*** (Please wait at least 1 minute before going to another page after pushing SUBMIT button; push only once.) ***<br>
You will have 30 DAYS to complete your registration via the authentication e-mail that will be sent to you.<br>If you do not respond within 30 days, your registration will be voided and deleted.</h3>
</div>
	<span class="corners-bottom"><span></span></span></div>
</div>
</form>
