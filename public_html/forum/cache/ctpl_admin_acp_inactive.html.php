...
<p><?php echo ((isset($this->_rootref['L_INACTIVE_USERS_EXPLAIN'])) ? $this->_rootref['L_INACTIVE_USERS_EXPLAIN'] : ((isset($user->lang['INACTIVE_USERS_EXPLAIN'])) ? $user->lang['INACTIVE_USERS_EXPLAIN'] : '{ INACTIVE_USERS_EXPLAIN }')); ?><br><br>
POLICY NOTE: DO NOT MANUALLY APPROVE ANY INACTIVE USER; UNLESS A PENDING COPPA REGISTRATION, AFTER PERMISSION FORM IS RECEIVED.  CHECK GROUP FOR PENDING USER TO SEE IF COPPA.
ALSO, CHECK PROFILE TO SEE IF PENDING OR NEW USER IS A ZENDO MEMBER -- IF RECOGNIZED, MOVE TO ZENDO MEMBER GROUP !!!
