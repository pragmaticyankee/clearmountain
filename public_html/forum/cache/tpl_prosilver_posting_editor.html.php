...
<fieldset class="fields1">
	...
	<div id="smiley-box">
		...
		<?php } if ($this->_rootref['BBCODE_STATUS']) {  if (sizeof($this->_tpldata['smiley'])) {  ?><hr /><?php } ?><!--  mods by JIM G to get rid of BB Code status notes on posting page -->
	<!--	<?php echo (isset($this->_rootref['BBCODE_STATUS'])) ? $this->_rootref['BBCODE_STATUS'] : ''; ?>  -->  &nbsp; <br />
		...
		<?php } ?><!-- <?php echo (isset($this->_rootref['SMILIES_STATUS'])) ? $this->_rootref['SMILIES_STATUS'] : ''; ?> --> &nbsp;
...
<?php if ($this->_tpldata['DEFINE']['.']['EXTRA_POSTING_OPTIONS'] == (1)) {  if (! $this->_rootref['S_SHOW_DRAFTS']) {  ?>
	...
	<div class="panel bg3" id="options-panel">
		...
		<fieldset class="fields1">
			<?php if ($this->_rootref['S_BBCODE_ALLOWED']) {  ?><!-- this is the checkbox to disable BB Codes, may want to get rid of this -->
